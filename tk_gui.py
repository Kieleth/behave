...
class TkGui(tk.Tk):
    ...
    def create_control(self):
        ...
        self.b_auto_adjust = tk.button(self.f_control, text='auto adjust', width=20,
                                  command=self.auto_adust)
        self.b_auto_adjust.grid()

        self.b_quit = tk.Button(self.f_control, text='Quit', width=20, command=self.destroy)
        self.b_quit.grid()

    def create_canvas(self):
        canvas_width = 400
        canvas_height = 300
        self.canvas = tk.Canvas(self.f_main, 
                   width=canvas_width, 
        ...
        self.canvas.pos = self.canvas.create_text(0,0,
                                      fill="white",font="Helvetica 14 italic",text="")
